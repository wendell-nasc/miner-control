...
if [ ! -f "$SCASH_BINARY" ]; then
    ...
    sudo wget https://github.com/doktor83/SRBMiner-Multi/releases/download/2.6.5/SRBMiner-Multi-2.6.5-Linux.tar.gz -P /home/wendell/SRBMiner/SRBMiner-Multi-2-6-5/
    sudo tar -xvf /home/wendell/SRBMiner/SRBMiner-Multi-2-6-5/SRBMiner-Multi-2.6.5-Linux.tar.gz -C /home/wendell/SRBMiner/SRBMiner-Multi-2-6-5/
...
"$SCASH_BINARY" --disable-gpu --algorithm randomscash --pool "$SCASH_POOL" --wallet "$SCASH_WALLET.$(hostname)" --donate-level 1 --cpu-threads "$SCASH_THREADS" &
